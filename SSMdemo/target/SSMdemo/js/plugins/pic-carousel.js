...
var st = createPicMove("idPicCarousel", "idSlider2", picCount);	//图片数量更改后需更改此数值
var nums = [];
//插入数字
...
st.onStart = function(){
	...
	forEach(nums, function(o, i){ o.className = st.Index == i ? "pic-cell on" : "pic-cell"; })
}
// 重新设置浮动
...
var resetScrollEle = function(){
	...
	slider2Li.css("width",w+"px");
	$('#idPicCarousel').css("width",w+"px");
}
